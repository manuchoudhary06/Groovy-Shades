...
export default function Navigation() {
  ...
  <div id="logo">
    ...
    <div id="utility">
      ...
      <i className="icons fa-solid fa-heart"></i>
      <i className="icons fa-solid fa-bag-shopping"></i>
    </div>
  </nav>
</header>
    </div>
